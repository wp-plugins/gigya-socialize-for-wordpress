...
The Gigya Social optimization plug-in aggregates authentication and social APIs from Facebook, Twitter, Google, Microsoft, Yahoo, LinkedIn, AOL and other OAuth & OpenID providers, giving sites the ability to:

* Authenticate users via social network and OpenID providers
* Increase site traffic by enabling users to easily share content with their friends and followers.


The plug-in is configurable; it requires little time and no programming knowledge to install. (Installations typically takes less than two minutes.). The plug-in is scalable and secure, using a standard authentication techniques to prevent account spoofing. 
...
You can read more about the installation steps and other advanced configuration options in Gigya's online documentation <a href="http://wiki.gigya.com/030_Gigya_Socialize_API_2.0/050_Socialize_Plugins/Wordpress_plugin" title="Wordpress installation Tutorial">here</a>
...
For question about installations or configuration, please contact
us at support@gigya-inc.com

== Screenshots ==

1. Wordpress Registration page with Gigya Plugin
2. Complete Registration by providing missing Email or linking to an existing account
3. Gigya administration panel
...
New visitors can register on your site using the built-in Gigya login component. The site will create a WordPress user account in the database and connect the social network account to that user. 
...
Yes, the design is fully configurable. Please log-in to your Gigya account (on www.gigya.com) to use our online component designer. When you are done designing, you can easily copy the configuration code to your gigya admin settings page.
...
We provide extensive support to customers that implements (or are working on implementing) the Gigya Plug-in. Please contact us at: support@gigya-inc.com 

Is the Gigya service free?

The Gigya service is free for evaluation purposes.

Please contact Gigya at 650.353.7230 or via  <a href="http://www.gigya.com/public/contact/" title="Contact Us">Contact Us</a> for information about pricing, services and technical support.